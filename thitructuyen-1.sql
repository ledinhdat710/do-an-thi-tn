...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 22, 2023 lúc 03:10 PM
...
(60, '<p>1 + 1 = ?</p>', '', '<p>1</p>', '<p>2</p>', '<p>3</p>', '<p>4</p>', 1, 1, 1, 1, '2023-11-14 13:00:42', '2023-11-14 13:00:42');
...
(50, 60, 'B', '2023-11-14 13:00:59', '2023-11-14 13:00:59');
...
(28, 1, 1, 1, '', '15', '2023-11-14', 10, 1, 'Thi thử', '2023-11-14 13:02:01', '2023-11-14 13:02:01'),
(29, 1, 1, 1, 'Đề thi Toán', '15', '2023-11-23', 10, 1, 'Thi thử', '2023-11-22 14:06:29', '2023-11-22 14:06:29');
...
INSERT INTO `giaovien` (`id_gv`, `id`, `hoten`, `hinhanh`, `gioitinh`, `diachi`, `sdt`, `email`, `password`, `id_mh`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `hocsinh` (`id_hs`, `id`, `hoten`, `hinhanh`, `diachi`, `gioitinh`, `ngaysinh`, `sdt`, `email`, `password`, `created_at`, `updated_at`) VALUES
...
(104, 1, 2, 1, 1, 'Yếu', 3, '2023-11-13 09:47:27', '2023-11-13 09:47:27'),
(105, 1, 2, 1, 1, 'Yếu', 3, '2023-11-13 09:51:22', '2023-11-13 09:51:22'),
...
(5, 'LDD', 'ledinhdat710@gmail.com', NULL, '$2y$10$iruFi6Ja7irh2hguYnih0uPld4fkw1czv7XCsW3UAEz3gVWl1o9ZO', 1, NULL, '2023-11-16 08:25:24', '2023-11-16 08:25:24'),
(6, 'hocsinh', 'hocsinh@gmail.com', NULL, '$2y$10$3091GuRW8qDtE8VZ9MzgyejYvz7apCOT/6LThK0ZDK664fzR00PJW', 0, NULL, '2023-11-17 14:46:17', '2023-11-17 14:46:17');
...
--
ALTER TABLE `cauhoi`
  MODIFY `id_cauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `dapandung`
  MODIFY `id_dad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT cho bảng `dethi`
--
ALTER TABLE `dethi`
  MODIFY `id_de` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `ketqua`
  MODIFY `id_kq` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
