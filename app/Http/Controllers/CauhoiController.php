...
class CauhoiController extends Controller
{
    ...
    public function getchitiet($id)
    {
        ...
        $dapan = CauHoi::where('cauhoi.id_cauhoi', $id)->get()->toArray();
        $dapan_tontai = DB::table('cauhoi')
            ->where('id_cauhoi', '=', $id)->get()->pluck('dapan');
        // dd($dapan);
    ...
    public function themcauhoipost(Request $request)
    {
        ...
        $this->validate(
            ...
            [
                ...
                'dapan.required' => 'Bạn chưa nhập đáp án',
    ...
    public function getsuach($id)
    {
        ...
        $mucdo = MucDo::all();
        $khoi = Khoi::all();
        return view('admin.cauhoi.suacauhoi', ['cauhoi' => $cauhoi, 'loaich' => $loai, 'mon' => $monthi, 'mucdo' => $mucdo, 'khoi' => $khoi]);
    }
