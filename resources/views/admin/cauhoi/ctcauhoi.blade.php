...
<div class="panel panel-default khung">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="fas fa-chalkboard-teacher"></i><b class="tbl"> THÔNG TIN CÂU HỎI</b></h6>
	</div>
	<!-- <div class="datatable"> -->
</div>
...
<div class="container">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#menu1">Xem chi tiết</a></li>
		...
		<!-- <div id="home" class="tab-pane fade in">
			...
			<form action="../cauhoi/themdapan" method="post" enctype="multipart/form-data">
				...
				<table class="table" style="font-size: 13px">
					<tr>
						<td colspan="1"></td>
						<td colspan="7"><b>Câu hỏi :</b> {!! $cauhoi->dapan !!}</td>
					...
					<tr>
						...
						<td colspan="1"></td>
						<td colspan="7"><b>Loại câu hỏi : <span style="color: red">{!! $cauhoi->loaich->tenloai
									!!}</span></b></td>
					...
					<tr>
						<td colspan="8">
							<h6 class="panel-title"><i class="fas fa-chalkboard-teacher"></i><b>Đáp án đúng</b></h6>
						</td>
					...
					<tr>
						...
						<td>
							<span id="tenmucdo"
								style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">A</span>
							<input type="radio" class="custom-control-input" value="A" name="chon[]" class="select">
						</td>
						<td>
							<span id="tenmucdo"
								style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">B</span>
							<input type="radio" class="custom-control-input" id="" value="B" name="chon[]"
								class="select">
						</td>
						<td>
							<span id="truefalse3">
								<span id="tenmucdo"
									style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">C</span>
								<input type="radio" class="custom-control-input" id="" value="C" name="chon[]"
									class="select">
							</span>
						</td>
						<td>
							<span id="truefalse4">
								<span id="tenmucdo"
									style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">D</span>
								<input type="radio" class="custom-control-input" id="" value="D" name="chon[]"
									class="select">
						</td>
						@else
						@if($cauhoi->loaich->id_loaich==4)
						...
						<td>
							<span id="tenmucdo"
								style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">B</span>
							<input type="checkbox" class="custom-control-input" id="" value="B" name="chon[]"
								class="select">
						</td>
						<td>
							<span id="truefalse3">
								<span id="tenmucdo"
									style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">C</span>
								<input type="checkbox" class="custom-control-input" id="" value="C" name="chon[]"
									class="select">
							</span>
						</td>
						<td>
							<span id="truefalse4">
								<span id="tenmucdo"
									style="border: 1px solid #B1A8A8;padding: 7px; font-weight:bold;">D</span>
								<input type="checkbox" class="custom-control-input" id="" value="D" name="chon[]"
									class="select">
						</td>
						<td colspan="3"></td>
						@endif
				...
				<div class="row abc">
					...
					<div class="col-md-6" style="margin-top: 40px;margin-bottom: 40px;">
						<table class="table table-bordered ctbtl">
							...
							<tr class="tbl">
								<td class="style_row" id="style"><i class="fa fa-edit"></i> &nbsp; &nbsp;Tên Loại Câu
									Hỏi</td>
								<td>{{$cauhoi->loaich->tenloai}}</td>
							</tr>

							<tr class="tbl">
								<td class="style_row " id="style"><i class="fa fa-edit"></i> &nbsp; &nbsp;Tên Mức độ
								</td>
							...
							<tr class="tbl">
								<td class="style_row" id="style"><i class="fa fa-edit"></i> &nbsp; &nbsp;Tên Môn Thi
								</td>
							...
							<tr class="tbl">
								<td class="style_row" id="style"><i class="fa fa-edit"></i> &nbsp; &nbsp;Đáp Án Đúng
								</td>
								<td>
									@foreach($dapan as $da )
									<span>
										&nbsp; &nbsp;<span id="dad">{{ $da['dapan'] }}</span> &nbsp; &nbsp;
									</span>
									@endforeach
								</td>
							</tr>
