    ...
    <div class="container-fluid">
        ...
        <div class="container main_lichsu">
            <div class="header_lichsu">
                ...
                <div class="information"><b>Đề: {{$ct->trangthai}} | <b>Môn: {{$ct->tenmh}}</b> | <b>Số câu:
                            {{$ct->socau}} câu</b> | <b>Thời gian thi: {{$ct->thoigianthi}} phút</b></b></div>
                @endforeach
            </div>
            ...
            <div class="content1">
                ...
                <label style="background: red" class="option"><input type="radio" name="option" value="D"><span
                        id="opt"> D. {!!$ct->d!!}</span></label>
