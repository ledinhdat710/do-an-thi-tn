...
<div class="container" id="main">
    <div class="row giohang">
        ...
        <div class="col-md-5 ">
            <h3 class="thongtinctde" style="text-transform: uppercase;"><b>{{ $dt->tendethi}}</b></h3>
            ...
            <p class="review">
                <span class="glyphicon glyphicon-ok"> </span> Hệ thống tự động kết thúc bài, tính điểm khi hết giờ làm
                bài
            </p>
            <p class="review">
            ...
            <a href="thamgiathi/{{ $dt->id_de}}"><button type="button" class="btn warning" id="giohang">THAM GIA
                    NGAY</button></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div>
                                ...
                                <p>
                                    <textarea name="noidung" placeholder="Nhập nội dung thảo luận" id="" cols="90"
                                        rows="5"></textarea>
                                </p>
