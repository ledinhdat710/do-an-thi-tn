...
<div class="design_cauhoi">
    ...
    <div class="menunguoidung" id="menunguoidung">
        @foreach($kythi as $kt)
        <p><a href="../ketqua/exportKetQua/{{$kt->id_ky}}"><b>Kỳ Thi {{$kt->tenky}}</b> <i
    ...
    <div class="datatable">
        <form style="margin-top:7px;" method="get" id="searchform" action="searchketqua">
            <div class="email-box row" style="margin-left:7px">
                <div class="col-md-3">
                    ...
                    <input class="from-control nhaploai-search" type="search" placeholder="Nhập tên đề thi"
                        name="key" value="{{ session()->get('key') }} "/>
                </div>
        ...
        <div class="col-md-6">
            ...
            <div style="justify-content:space-between">
                <input class="from-control nhaploai-search" style="margin-right:5px" type="date"
                    placeholder="Nhập tên giáo viên" name="tungay" />
                <input class="from-control nhaploai-search" type="date" placeholder="Nhập tên giáo viên"
                    name="denngay" />
            </div>
        </div>
        <div class="col-md-2">
