...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="fas fa-chalkboard-teacher"></i>DANH SÁCH ĐỀ THI</h6>
	</div>
	<div class="datatable">
		@if(count($errors)>0)
			...
			<tbody>
				...
				foreach ($dethi as $dt) : $stt ?>
					<tr>
						...
						<td><a onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" href="xoadethi/{{$dt->id_de}}">
