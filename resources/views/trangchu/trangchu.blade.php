...
<head>
	<meta charset="UTF-8">
	<title>Thi Trực Tuyến 11111</title>
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
<link rel="stylesheet" type = "text/css" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
<link rel="stylesheet" type = "text/css" href="../../../public/css/fontawesome/css/all.css">
<link rel="stylesheet" type = "text/css" href="../../../public/css/hocsinh.css">
<link rel="stylesheet" type = "text/css" href="../../../public/css/anhchuyendong.css">
<!-- 2 follow links is to count number up -->
<!-- <script src="../../../public/js/counter_up/jquery.counterup.js"></script> -->
<!-- <script src="../../../public/js/waypoint/jquery.waypoints.js"></script> -->
...
<body>
		...
		<div class="menu-top">
			<div class="row">
				...
				<!-- <div class="col-md-2">
					<div class="login"><i class="fas fa-user"></i> Đăng ký</div>
				</div> -->
			</div>
		</div>
							    ...
							    <div id="home" class="tab-pane fade in active">
							     <div class="row hinhanh">
							     	...
							     	<div class="col-md-3 dethi thumb">
							     		<img src="../../../public/imgs/monhoc/ngoaingu.jpg" width="199" height="150" alt="">
							     	...
							     	<div class="col-md-3 dethi">
							     		<img src="../../../public/imgs/monhoc/vatli_1.jpg" width="199" height="150" alt="">
							     		<p class="tenmon">Ngoại Ngữ</p>
							     		<p class="title">Đề thi THPT Quốc gia gồm 40 câu, thời gian thi 50 phút</p>
							     		<p class="danhgia">
							     	...
							     	<div class="col-md-3 dethi">
							     		<img src="../../../public/imgs/monhoc/sinh hoc.jpg" width="199" height="150" alt="">
							     		<p class="tenmon">Ngoại Ngữ</p>
							     		<p class="title">Đề thi THPT Quốc gia gồm 40 câu, thời gian thi 50 phút</p>
							     		<p class="danhgia">
							     	...
							     	<div class="col-md-3 dethi">
							     		<img src="../../../public/imgs/monhoc/toan.jpg" width="199" height="150" alt="">
							     		<p class="tenmon">Ngoại Ngữ</p>
							     		<p class="title">Đề thi THPT Quốc gia gồm 40 câu, thời gian thi 50 phút</p>
							     		<p class="danhgia">
	...
	<div class="row">
		<div class="col-md-2">
			<img src="../../../public/imgs/banner/bg-utility_.png" alt="" width="250" height="400">
		</div>
		<div class="col-md-8">
			<div class="row ctloi">
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-kiem-tra-thi-8.png" alt="">
					<p>Phù hợp với quy trình thi</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-cau-hoi-da-dang-6.png" alt="">
					<p>Hỗ trợ phần mềm nhanh, hiệu quả</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-hoc-tu-vung-2.png" alt="">
					<p>Tránh gian lận trong thi cử</p>
				</div>
			</div>
			<div class="row ctloi">
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-nhac-lich-hoc-4.png" alt="">
					<p>Nhắc nhở lịch học hằng ngày</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-noi-dung-9.png" alt="">
					<p>Quản lý ngân hàng câu hỏi</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-thong-ke-ky-nang-5.png" alt="">
					<p>Quản lý đề thi đa dạng</p>
				</div>
			</div>
			<div class="row ctloi">
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-tra-tu-dien-1.png" alt="">
					<p>Tiết kiệm thời gian</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-tuong-tac-cao-7.png" alt="">
					<p>Tính tương tác cao(Chat, Bình luận)</p>
				</div>
				<div class="col-md-4">
					<img src="../../../public/imgs/banner/icon-xem-live-stream-3.png" alt="">
					<p>Tương tác và giải đáp trực tiếp</p>
				</div>
			</div>
		</div>
		<div class="col-md-2">
			<img src="../../../public/imgs/banner/bg-utility_.png" width="250" height="400" alt="">
		</div>
	</div>
			...
			<div class="col-md-4">
				<div class="card middle">
					<div class="front anhfb1">
						...
						<p class="fb1"><img src="../../../public/imgs/fb1.png" alt=""></p>
			...
			<div class="col-md-4">
				<div class="card middle">
					<div class="front anhfb2">
						<p class="fb1"><img src="../../../public/imgs/fb2.jpg" alt=""></p>
			...
			<div class="col-md-4">
				<div class="card middle">
					<div class="front anhfb3">
						<p class="fb1"><img src="../../../public/imgs/fb3.png" alt=""></p>
		...
		<div class="container phanchan">
			...
			<div class="col-md-3">
				...
				<div class="col-md-12 footer_lienhe">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<p><img src="../../../public/imgs/logo-light.png" alt="" ></p>
